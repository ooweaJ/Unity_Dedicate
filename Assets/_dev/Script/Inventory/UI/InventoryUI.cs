...
public class InventoryUI : MonoBehaviour
{
    ...
    public event Action<int, Vector2, ItemType> OnItemRightClicked;
    ...
    private void HandleSlotRightClicked(int id, Vector2 pos) => OnItemRightClicked?.Invoke(id, pos, targetType);
